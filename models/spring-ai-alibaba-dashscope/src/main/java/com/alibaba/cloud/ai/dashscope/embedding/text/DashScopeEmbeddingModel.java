...
public class DashScopeEmbeddingModel extends AbstractEmbeddingModel {
    ...
    private DashScopeApiSpec.EmbeddingRequest createRequest(EmbeddingRequest request) {
        ...
        Assert.notNull(requestOptions, "DashScopeEmbeddingOptions must not be null");
        Assert.notNull(requestOptions.getModel(), "Embedding model must not be null");
    ...
    public static final class Builder {
        ...
        public DashScopeEmbeddingModel build() {
            Assert.notNull(this.dashScopeApi, "dashScopeApi cannot be null");
