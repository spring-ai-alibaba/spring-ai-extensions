...
public class AnalyticDbVectorStoreProperties extends CommonVectorStoreProperties {
	...
	public static final String CONFIG_PREFIX = "spring.ai.vectorstore.analyticdb";

	private @Nullable String collectName;
	...
	public @Nullable String getCollectName() {
		return collectName;
	}
	...
	public Map<String, @Nullable Object> toAnalyticDbClientParams() {
